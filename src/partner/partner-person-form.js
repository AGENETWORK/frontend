...
function PartnetPersonForm ({isVisable, firstName, midName, lastName, email, confirmEmail, extractInfo}){
          ...
          <div className="form-group">
            ...
            <div className="row">
              <div className="col col-md-4 col-xs-12">
                <input type="text" className="form-control" value={firstName} name="firstName" placeholder="First Name" 
                  ref={register({ required: true })} ></input>
                  {errors.firstName && <span>required</span>}
              </div>
              <div className="col col-md-4 col-xs-12">
                <input type="text" className="form-control" value={midName} name="midName" placeholder="Middle Name" 
                  ref={register({ required: true })} ></input>
                  {errors.midName && "required"}
              </div>
              <div className="col col-md-4 col-xs-12">
                <input type="text" className="form-control" value={lastName} name="lastName" placeholder="Last Name" 
                  ref={register({ required: true })} ></input>
          ...
          <div className="form-group">
            ...
            <div className="row">
              <div className="col col-md-6 col-xs-12">
                <input className="form-control" type="text" value={email} name="email" placeholder="Your Mail" 
              ...
              <div className="col col-md-6 col-xs-12">
                <input className="form-control" type="text" value={confirmEmail} 
                  name="confirmEmail" placeholder="Confirm Mail" 
                  ref={register({ required: true,
          ...
          <div className="form-group">
            ...
            <div className="row">
              <div className="col col-md-12 col-xs-12">
                <textarea className="form-control" name="extractInfo"  
                  placeholder="Add more information..."
                
                  ref={register({ required: true, minLength: 20, maxLength: 500 })} >{extractInfo}</textarea>
