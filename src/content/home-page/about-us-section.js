...
const AboutUs = () => <section id="about">
  <div className="container">
    <header className="section-header">
      ...
      leadership and economic inclusion, and strengthen the capacity of girl-led groups in Africa for a
      Fairer Future.
    </h6>
    </header>
    ...
    <div className="row about-extra">
      ...
      <div className="col-lg-6 wow fadeInUp pt-5 pt-lg-0">
        ...
        <p>
          ...
          young women and girls leaders from among the community
          for planning and implementing of all the development
          programmes.
      </p>
        <p>
    ...
    <div className="row about-extra">
      ...
      <div className="col-lg-6 wow fadeInUp pt-4 pt-lg-0 order-2 order-lg-1">
        ...
        <p>
          ...
          has consistently involved the community stakeholders
          including the local council chairman and other community
          leaders in each and every step of its projects.
      </p>
        <p>
          This has, over
          the years, ensured that the participation of the community is
          full-fledged in all our activities and the communities feel a
          sense of ownership to the project
      </p>
        <p>
