    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-md-6 col-lg-5 offset-lg-1 wow bounceInUp" data-wow-duration="1.4s">
          <div className="box">
            <div className="icon">
              <i className="ion-ios-people-outline" style={{ color: "#ff689b" }} />
            </div>
            <h4 className="title">
        ...
        <div className="col-md-6 col-lg-5 wow bounceInUp" data-wow-duration="1.4s">
          <div className="box">
            <div className="icon">
              <i className="ion-ios-bookmarks-outline" style={{ color: "#e9bf06" }} />
            </div>
            <h4 className="title">
              <a href="">Innovation</a>
            </h4>
        ...
        >
          <div className="box">
            <div className="icon">
              <i className="ion-ios-paper-outline" style={{ color: "#3fcdc7" }} />
            </div>
            <h4 className="title">
              <a href="">Team Work</a>
            </h4>
        ...
        >
          <div className="box">
            <div className="icon">
              <i className="ion-ios-speedometer-outline" style={{ color: "#41cf2e" }} />
            </div>
            <h4 className="title">
        ...
        >
          <div className="box">
            <div className="icon">
              <i className="ion-ios-world-outline" style={{ color: "#d6ff22" }} />
            </div>
            <h4 className="title">
        ...
        >
          <div className="box">
            <div className="icon">
              <i className="ion-ios-clock-outline" style={{ color: "#4680ff" }} />
            </div>
            <h4 className="title">
              <a href="">Integrity</a>
            </h4>
